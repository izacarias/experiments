...
class CustomTopology(Topo):
    def build(self):
        ...
        self.addLink(g1_sw1, g1_sw2, bw=99, loss=0.5)    # l_1
        self.addLink(g1_sw2, g1_sw3, bw=96, loss=0.5)    # l_2
        self.addLink(g1_sw1, g1_sw3, bw=100, loss=0.5)    # l_3
        
        # Connect switches within group g2
        self.addLink(g2_sw4, g2_sw5, bw=93, loss=0.5)    # l_4
        self.addLink(g2_sw5, g2_sw6, bw=100, loss=0.5)    # l_5
        self.addLink(g2_sw4, g2_sw6, bw=95, loss=0.5)    # l_6
        
        # Connect switches within group g3
        self.addLink(g3_sw7, g3_sw8, bw=89, loss=0.5)    # l_7
        self.addLink(g3_sw8, g3_sw9, bw=91, loss=0.5)    # l_8
        self.addLink(g3_sw7, g3_sw9, bw=97, loss=0.5)    # l_9
